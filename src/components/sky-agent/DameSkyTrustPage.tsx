...
import { Crown, Shield, Lock, Eye, EyeOff, Globe, Users, CheckCircle2, Server, Key, Cpu } from 'lucide-react';
                ...
                <section>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="bg-gradient-to-r from-emerald-950/50 to-transparent border border-emerald-700/30 rounded-2xl p-7">
                            ...
                            <p className="text-slate-300 leading-relaxed">
                                Dame SKY ne connaît que le <strong className="text-white">prénom et l&apos;école</strong> de votre enfant.
                                Les conversations <strong className="text-white">disparaissent après 30 minutes</strong>.
                                Aucun profilage commercial des mineurs, aucune publicité. Dame SKY signale automatiquement à la direction tout propos inapproprié ou tentative de fraude.
                            </p>
                        </div>
                        <div className="bg-gradient-to-r from-indigo-950/50 to-transparent border border-indigo-700/30 rounded-2xl p-7">
                            ...
                            <p className="text-slate-300 leading-relaxed">
                                Dame SKY est là pour t&apos;aider à <strong className="text-white">vraiment apprendre</strong>.
                                Réponses honnêtes, rigoureuses, sans flatterie. Elle te challengera avec des quiz et te récompensera en Sky Points quand tu fais l&apos;effort de comprendre.
                                Tes conversations sont privées et disparaissent après 30 min. Si tu essaies de tricher, elle refusera et le signalera. C&apos;est une mentore, pas un complice.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="text-center">
                    <div className="bg-gradient-to-br from-amber-950/40 to-orange-950/20 border border-amber-700/30 rounded-3xl p-12">
                        ...
                        <p className="text-slate-400 max-w-xl mx-auto mb-8">
                            Dame SKY est construite sur l&apos;architecture technique la plus transparente possible.
                            Vous avez toutes les clés. Vous avez tout le contrôle. C&apos;est ça, une IA qui respecte vraiment les écoles.
                        </p>
