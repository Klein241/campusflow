    ...
    return (
        <div className="relative min-h-screen bg-linear-to-b from-[#0B0E14] to-[#0F1219] text-white pb-24">
            ...
            <div className="relative z-10 max-w-4xl mx-auto w-full">
                ...
                >
                    <h1 className="text-2xl font-black tracking-tight bg-linear-to-r from-white via-pink-200 to-purple-200 bg-clip-text text-transparent">Journal Personnel</h1>
                    <p className="text-slate-500 text-xs font-medium mt-0.5">Vos réflexions et notes personnelles</p>
                </motion.div>
                        ...
                        {Object.keys(groupedEntries).length === 0 ? (
                            ...
                            >
                                ...
                                <p className="text-sm text-slate-500 mt-1">
                                    Commencez à écrire vos réflexions
                                </p>
                            </motion.div>
                        ) : (
