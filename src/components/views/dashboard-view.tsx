...
import { getDay } from '@/lib/curriculum-data';
...
// ===== MAIN HOME VIEW =====
export function DashboardView({ onNavigateToDay, onNavigateTo }: DashboardViewProps) {
    const { user, currentDay, streak, totalDaysCompleted, appSettings, setCoursesViewTarget } = useAppStore();
                    ...
                    >
                        ...
                        <div className="grid grid-cols-4 gap-2">
                            {[
                                ...
                                { icon: <BookOpen className="w-5 h-5" />, label: 'courses', color: 'from-amber-600 to-orange-600' },
                            ...
                            {socialLinks.length > 0 ? (
                                ...
                                <>
                                    ...
                                    <a href="https://facebook.com" target="_blank" rel="noopener noreferrer"
                                        ...
                                        <div className="flex-1"><p className="font-bold">Facebook</p><p className="text-sm opacity-70">Forum étudiant</p></div>
                                        <ExternalLink className="w-4 h-4 opacity-50" />
                                    </a>
