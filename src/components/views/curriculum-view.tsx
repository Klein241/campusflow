...
export function CurriculumView({ onSelectDay }: CurriculumViewProps) {
    ...
    const filteredProgram = useMemo(() => curriculumData.filter(day => {
    ...
    const weeks = useMemo(() => Array.from({ length: 6 }, (_, i) => ({
        ...
        totalInWeek: curriculumData.filter(d => Math.ceil(d.day / 7) === i + 1).length,
                        ...
                        >
                            ...
                            <div className="flex-1 text-left">
                                ...
                                <p className="text-white font-bold text-sm mt-0.5 line-clamp-1">
                                    {curriculumData.find(d => d.day === currentDay)?.title || `Jour ${currentDay}`}
                                </p>
                            </div>
